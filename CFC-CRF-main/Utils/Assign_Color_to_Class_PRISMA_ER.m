function [ Class_RGB ] = Assign_Color_to_Class_PRISMA_ER( label )
...
Class_RGB = label;
Class_RGB(:,:,1) = 233*(label==1) + 169*(label==2) + 255*(label==3) + 0*(label==4) + 158*(label==5) + 249*(label==6) + 121*(label==7);
Class_RGB(:,:,2) = 199*(label==1) + 4*(label==2) + 243*(label==3) + 128*(label==4) + 229*(label==5) + 198*(label==6) +  192*(label==7);
Class_RGB(:,:,3) = 255*(label==1) + 0*(label==2) + 191*(label==3) + 64*(label==4) + 1*(label==5) + 171*(label==6) +  144*(label==7);
